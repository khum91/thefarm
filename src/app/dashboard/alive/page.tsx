  ...
  return (
    <div className="w-full">
      <div className="flex w-full flex-col items-center justify-between">
        <h1 className={`${lusitana.className} text-2xl`}>Alive Categories.</h1>
      </div>
